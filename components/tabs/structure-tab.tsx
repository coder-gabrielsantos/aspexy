      ...
      <section className="app-panel overflow-hidden">
        <div className="overflow-x-auto">
          <table className="w-full min-w-[984px] table-fixed border-collapse">
            ...
            <thead>
              <tr>
                <th className="border-b border-slate-200/90 bg-slate-50/80 px-3 py-2.5 text-center text-xs font-medium uppercase tracking-wide text-slate-500">
                  Horário
                </th>
                {DAYS.map((day) => (
                  <th key={day} className="border-b border-slate-200/90 bg-slate-50/80 px-2 py-2.5 text-center text-xs font-medium uppercase tracking-wide text-slate-500">
                    {day}
                  </th>
                ))}
                <th className="border-b border-slate-200/90 bg-slate-50/80 px-1 py-2.5" />
              </tr>
            </thead>
            <tbody>
              {s.slots.map((slot, si) => (
